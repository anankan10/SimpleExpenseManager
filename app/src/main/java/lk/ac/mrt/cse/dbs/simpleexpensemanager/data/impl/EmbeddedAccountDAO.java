...
public class EmbeddedAccountDAO  implements AccountDAO {
    ...
    public List<String> getAccountNumbersList() {
        ...
        Cursor cursor = database.rawQuery(account_numbers_query, null);
        try {
    ...
    public List<Account> getAccountsList() {
        ...
        String account_detail_query = "SELECT * FROM Account";

        Cursor cursor = database.rawQuery(account_detail_query, null);
